<a href="https://hits.seeyoufarm.com"><img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2Fkushvaharavi%2FkushvahaRavi.githu.io&count_bg=%2379C83D&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=hits&edge_flat=false"/></a>

Please give a star and link to this repo in your website, so that the project can grow.

<p align="center">
    <a href="https://kushvahaRavi.github.io" target="_blank">
    <img src="images/theme.gif" align="center"></img>
    </a>
</p>

# Demo
To view a live demo, **[click here](https://kushvahaRavi.github.io/)**
...
- Remove `<meta http-equiv="refresh" content="0;url=https://kushvahaRavi.github.io/" />` in the `index.html` file
...
- Open up cmd/powershell in admin mode and enter the following line to download this repository
  ...
  - ```python
     git clone https://github.com/kushvahaRavi/kushvahaRavi.git.io.git
    ```
